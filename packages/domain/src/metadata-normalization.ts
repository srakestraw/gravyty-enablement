 ...
 */
export function normalizeMetadataFieldsFromStorage<T extends Record<string, any>>(
  item: T
): T {
 ...
 */
export function prepareMetadataFieldsForStorage<T extends Record<string, any>>(
  item: T
): T {
