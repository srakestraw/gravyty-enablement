 ...
 */
export const sampleCourseDetail = {
    course_id: 'course-1',
    title: 'Introduction to Sales Enablement',
...
export const sampleLessonDetail = {
    ...
    transcript: {
        ...
        lesson_id: 'lesson-1',
        video_media_id: 'media-1',
        segments: [
            {
                segment_id: 'seg-1',
                start_ms: 0,
                end_ms: 5000,
                text: 'Welcome to the course on sales enablement.',
            },
        ],
        full_text: 'Welcome to the course on sales enablement.',
        language: 'en',
        created_at: '2024-01-10T10:00:00Z',
        created_by: 'user-1',
 ...
 */
export const sampleLearningPathSummaries = [
    {
        path_id: 'path-1',
 ...
 */
export const sampleAssignmentSummaries = [
    {
        assignment_id: 'assignment-1',
 ...
 */
export const sampleCertificateSummaries = [
    {
 ...
 */
export const sampleCertificateTemplateSummaries = [
    {
        template_id: 'template-1',
