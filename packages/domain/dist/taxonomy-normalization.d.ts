/**
 * Taxonomy Field Normalization
 *
 * Helper functions for normalizing taxonomy fields between legacy and new naming conventions.
 *
 * Renaming:
 ...
 */
/**
 * Normalize taxonomy fields when reading from storage (DynamoDB).
 *
 ...
 */
export declare function normalizeTaxonomyFieldsFromStorage<T extends Record<string, any>>(item: T): T;
/**
 * Prepare taxonomy fields for writing to storage.
 *
 ...
 *
 * @param item Record with taxonomy fields
 * @returns Record ready for storage (new fields written, legacy kept for compat)
 */
export declare function prepareTaxonomyFieldsForStorage<T extends Record<string, any>>(item: T): T;
//# sourceMappingURL=taxonomy-normalization.d.ts.map