 ...
 */
export function scheduleVersion(version, publishAt // ISO datetime
) {
 ...
 */
export function publishVersion(version, publishedBy, changeLog) {
 ...
 * Expire a version
 */
export function expireVersion(version) {
 ...
 * Archive a version
 */
export function archiveVersion(version) {
    const allowedStatuses = ['published', 'deprecated', 'expired'];
